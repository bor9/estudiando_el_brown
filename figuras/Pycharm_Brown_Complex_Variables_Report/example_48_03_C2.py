...
plt.text(xl, yl, r'$C_2$', fontsize=fontsize, ha='right', va='bottom')
...
# circle labels
ytm2 = -0.12
plt.text(-ytm, r, '$i$', fontsize=fontsize, ha='left', va='center')
plt.text(-ytm, -r , '$-i$', fontsize=fontsize, ha='left', va='center')
...
# save as pdf image
plt.savefig('example_48_03_C2.pdf', bbox_inches='tight')
