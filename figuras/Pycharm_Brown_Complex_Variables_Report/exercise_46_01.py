...
plt.text(-xl, -yl, r'$C_2$', fontsize=fontsize, ha='right', va='top')
...
# circle labels
plt.text(r + 0.07, xtm, '$2$', fontsize=fontsize, ha='left', va='baseline')
plt.text(-1 - 0.07, xtm, '$-2$', fontsize=fontsize, ha='right', va='baseline')

plt.axis('off')

# save as pdf image
plt.savefig('exercise_46_01.pdf', bbox_inches='tight')
